...
const styles = StyleSheet.create({
  container: { padding: 20, borderRadius: 16, margin: 10 },
  ...
  title: { fontSize: 18, fontWeight: '600', textAlign: 'center', marginBottom: 6 },
  subtitle: { fontSize: 15, textAlign: 'center', marginBottom: 20, lineHeight: 22 },
  primaryGrid: { gap: 12 },
  primaryButton: { padding: 18, borderRadius: 12, marginBottom: 12, alignItems: 'center' },
  primaryEmoji: { fontSize: 36, marginBottom: 10 },
  primaryText: { fontSize: 14, fontWeight: '600', textAlign: 'center', lineHeight: 18 },
  secondaryList: { gap: 10 },
  secondaryButton: { padding: 16, borderRadius: 12, marginBottom: 10 },
  secondaryText: { fontSize: 16, fontWeight: '600', textAlign: 'center' },
  tertiaryList: { gap: 10, marginBottom: 20 },
  tertiaryButton: { padding: 14, borderRadius: 10, marginBottom: 10 },
  tertiaryText: { fontSize: 15, fontWeight: '500', textAlign: 'center' },
  tertiaryActions: { flexDirection: 'row', gap: 10, marginTop: 10 },
  skipButton: { flex: 1, padding: 15, borderRadius: 10, alignItems: 'center' },
  skipText: { fontSize: 16, fontWeight: '600' },
  continueButton: { flex: 1, padding: 15, borderRadius: 10, alignItems: 'center' },
  continueText: { color: 'white', fontSize: 16, fontWeight: '600' },
  notesInput: { borderWidth: 1, borderRadius: 10, padding: 14, minHeight: 100, textAlignVertical: 'top', marginBottom: 20, fontSize: 16 },
