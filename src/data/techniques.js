export const dbtCbtTechniques = {
  grounding: [
    ...
    { name: '4-7-8 Breathing', description: 'Inhale 4, hold 7, exhale 8 for deep relaxation', example: 'Example: Inhale quietly through nose for 4 counts, hold breath for 7 counts, exhale completely through mouth for 8 counts. Developed by Dr. Andrew Weil for sleep and anxiety.', keywords: ['sleep', 'relaxation', 'anxiety', 'calm'] },
    { name: 'Resonant Breathing', description: '5-second inhale, 5-second exhale for balance', example: 'Example: Breathe in slowly for 5 counts, breathe out slowly for 5 counts. This 6-breaths-per-minute pattern optimizes heart rate variability and emotional balance.', keywords: ['balance', 'heart rate', 'calm', 'steady'] },
    { name: 'Physiological Sigh', description: 'Double inhale, long exhale for quick stress relief', example: 'Example: Take a quick inhale through nose, immediately take another quick inhale, then one long slow exhale. Rapidly reduces stress and resets your nervous system.', keywords: ['stress', 'quick', 'reset', 'emergency'] },
    { name: 'Triangle Breathing', description: 'Simple 3-count inhale, hold, exhale pattern', example: 'Example: Inhale for 3 counts, hold for 3 counts, exhale for 3 counts. Perfect for beginners or when you need something simple and easy to remember.', keywords: ['simple', 'beginner', 'easy', 'basic'] }
  ],
  distress_tolerance: [
